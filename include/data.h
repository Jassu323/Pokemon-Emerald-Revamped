...
struct TrainerMonItemEVsAndCustomMoves
{
    u16 iv;
    u8 lvl;
    u8 evs[NUM_STATS];
...
#define ITEM_EVS_CUSTOM_MOVES(party) { .ItemEVsAndCustomMoves = party}, .partySize = ARRAY_COUNT(party), .partyFlags = F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_EVS
...
union TrainerMonPtr
{
    ...
    const struct TrainerMonItemEVsAndCustomMoves *ItemEVsAndCustomMoves;
};
